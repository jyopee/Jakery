...
<body>
	...
	<section class="ftco-section">
		<div class="container">
			<div class="row">
			<div>
			<img src='images/ch.png' width="830" height="200">
				<div class="col-md-9">
					<div class="row mb-4">
						<div
						...
						<c:forEach var="pro" items="${products}"
							...
							<div class="col-md-4 d-flex">
								...
								<div class="product ftco-animate" style="cursor: pointer;"
									...
									<form id="frm" action="productSingle.do" method="post">
					...
					<script type="text/javascript">
						function selectInfo() { //선택글 상세보기
							console.log(event.target.parentNode.parentNode.children[0].submit())
						}
						...
						<div class="categories">
							...
							<ul class="p-0">
								...
								<li><a href="giftSetCategoryForm.do">GiftSet <span
										class="fa fa-chevron-right"></span></a></li>
								<li><a href="eventCategoryForm.do">Season<span
										class="fa fa-chevron-right"></span></a></li>
							</ul>
						</div>
					</div>
