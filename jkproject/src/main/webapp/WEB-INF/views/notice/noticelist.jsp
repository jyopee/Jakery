				...
				<div class="col-md-9 ftco-animate mb-5 text-center">
					<p class="breadcrumbs mb-0">
						<span class="mr-2"><a href="index.html">Home <i
								class="fa fa-chevron-right"></i></a></span> <span>Noitices <i
	...
	<div class="board_wrap">
		...
		<div id="notice">
			<table border="1">
				<thead>
					...
					<tr>
						<th width="70" align="center">NUM</th>
						<th width="250" align="center">TITLE</th>
						<th width="150" align="center">DATE</th>
						<th width="150" align="center">views</th>
						<th width="150" align="center">WRITER</th>
					</tr>
				</thead>
				<tbody>
		...
		<div id="button">
			<form id="frm" action="noticeSelect.do" method="post">
				...
				<input type="hidden" id="noticeId" name="noticeId" value=id>
			</form>

			<form id="writefrm" action="noticeInsertForm.do" method="post">
