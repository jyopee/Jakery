...
<body>
	...
	<!-- 글작성 폼 -->
	<div class="container">
		<form name="ajaxFrm" id="ajaxFrm" action="reviewInsert.do"
			method="post">
			<div class="container">
			<br>
				<fieldset>
				...
				<table class="table table-sm">
					<tr>
						...
						<td><input type="text" id="memberName" name="memberName"
							value="${memberName}" readonly="readonly"></td>
					</tr>
					<tr>
						<th>제 목</th>
						<td><input type="text" id="prReviewTitle"
							name="prReviewTitle" class="col-12"></td>
					</tr>
					<tr>
						<th>내 용</th>
						<td><textarea id="prReviewSubject" name="prReviewSubject"></textarea>
					</tr>
			...
			<div>
				<input type="hidden" name="memberId" value="${memberId }"> <input
					type="hidden" name="prId" value="${prId }"> <input
	...
	<script type="text/javascript">
		...
		//취소버튼
		function back() {
			ajaxFrm.action = "productSingle.do";
			ajaxFrm.submit();
		}
