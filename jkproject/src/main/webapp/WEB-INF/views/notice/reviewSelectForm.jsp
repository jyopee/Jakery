...
<body>
	...
	<div class="container">
		...
		<h2 style="margin-left: 22px; color: black;" >Review</h2>
			<table class="table">
				...
				<tr>
					...
					<td style="color: #404040;" id="reviewStar">
					  <input type="hidden" id="star" value="${prReview.prReviewStar }"></td>
				</tr>
				<tr>
					<th>제 목</th>
		...
		<form id="frm" action="" method="post">
				...
				<input type="hidden" id="prReviewId" name="prReviewId" value="${prReview.prReviewId }">
				<input type="hidden" id="prId" name="prId" value="${prReview.prId }">
		</form>
	</div>
	</div>
...
<script type="text/javascript">	
		...
		function reviewEdit(str) {
			if (str == 'E') {
				frm.action = "reviewUqdateForm.do";  
			} else {
				let yn = confirm("문의글을 삭제하시겠습니까?");
				if (yn) {
					frm.action = "reviewDelete.do"; //만드어야함
				} else {
					return false;
				}
