...
<body>
	...
	<div class="container">
		...
		<h2 style="margin-left: 22px; color: black;" >Qna</h2>
			...
			<input type="hidden" id="memberRole" value="${memberRole }">
			</div>
			...
			<div class="container">
				<table class="table table-sm">
					...
					<td><input type="text" style="display: none;"><input id="prQnaComSubject" name="prQnaComSubject" style="width: 800px; height:200px; margin-left: 50px;" >
						</tr>
				</table>
			</div>
			<br>
			<div>
				<input type="hidden" id="comMemberId" name="memberId"  value="${prQnaCom.memberId }">   
				<input type="hidden" id="comPrQnaId" name="prQnaId" value="${prQnaCom.prQnaId }"> 
...
// 	}
		...
		function qnaEdit(str) {
			if (str == 'E') {
				frm.action = "qnaUqdateForm.do";  
			} else {
				let yn = confirm("문의글을 삭제하시겠습니까?");
				if (yn) {
					frm.action = "qnaDelete.do"; //만드어야함
				} else {
					return false;
				}
